...
const projects = [
    ...
    {   
        ...
        description: 'Yacht Rental is a web application built using React and Rails. The primary function of the website is to allow users to book yacht reservations. It is a mobile-responsive website, and I developed this project with two teammates from Microverse.',
        image: yachtRental,
        sourceLink: 'https://github.com/HtetWaiYan7191/yacht_rental_front_end',
        liveLink:'https://beta-yacht-rental.netlify.app/',
        techStack: ['FullStack', 'Rails', 'React', 'PostgreSql'],
        cardOpen: false,
        carouselImage:[yachtDesktopSplash, yachtDesktopSignup, yachtDesktopMain, yachtDesktopDetail, yachtDesktopMyReservations, yachtDesktopDelete, yachtMobileSplash, yachtMobileMain, yachtMobileDetail, yachtMobileAdd, yachtMobileDelete, yachtMobileMyReservations]
    },
