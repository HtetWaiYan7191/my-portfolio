...
const ContactMe = () => {
  ...
  return (
    <section className='contact-me-section h-[200vh]'>
      ...
      <div className='contact-me my-10 flex flex-col justify-around'>
        ...
        <form className='form-container backdrop-blur-[sm]  bg-slate-900  py-10 px-5 rounded-md mx-auto '>
          ...
          <div className={`input-box my-7 relative w-[100%] mx-auto `}>
            <input type='email' className='w-[100%]' required value={email} onChange={handleEmailChange} />
            <span>Email</span>
          </div>
