...
const TestimonialCard = ({testimonial}) => {
  return (
    ...
    perspective={1000}
  >
    <div className='testimonial-card md:mt-5 border md:rounded-md rounded-br-[25%]  border-t-blue-400 border-r-blue-600 border-b-blue-700 shadow-lg shadow-blue-300 md:hover:shadow-blue-500 border-l-sky-300 rounded-tl-[10%] w-[90%] mx-auto bg-slate-900 p-5'>
        <div className="header flex items-center ">
            ...
            <div className='info-box flex flex-col'>
                <span className='text-sm text-white/90 font-semibold md:text-lg'>{testimonial.name}</span>
                <span className='text-xs text-white/80 md:text-sm'>{testimonial.country}</span>
            </div>
